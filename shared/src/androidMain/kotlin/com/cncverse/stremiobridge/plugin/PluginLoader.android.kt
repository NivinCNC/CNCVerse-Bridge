...
private fun Any.reflectToStreams(pluginName: String, api: Any? = null): List<StremioStream> {
    return try {
        ...
        if (url.contains(".mpd") && !clearkeyHex.isNullOrBlank()) {
            ...
            //if (com.cncverse.stremiobridge.state.ServerState.isStremioMode.value) {
            //    proxyBase = "https://cncverse.dpdns.org/$hostIp:${com.cncverse.stremiobridge.state.ServerState.serverPort}"
            //}
